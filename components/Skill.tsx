        ...
        <div className=' group relative flex cursor-pointer'>
            ...
            <div className=' absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-20 w-20'>
                <div className=' flex items-center justify-center h-full'>
                    <p className=' font-bold text-black opacity-100 text-xs'>Python</p>
                    <p className=' font-bold text-black opacity-100 text-xs'>100%</p>
                </div>
            </div>
            <div className=' absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-20 w-20'>
                <div className=' flex items-center justify-center h-full'>
                    <p className=' font-bold text-black opacity-100 text-xs'>angular</p>
                    <p className=' font-bold text-black opacity-100 text-xs'>100%</p>
                </div>
            </div>
        </div>
